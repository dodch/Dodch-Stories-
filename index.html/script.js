...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Quattrocento+Sans:ital,wght@1,400&family=Open+Sans:wght@400;700&family=Playfair+Display:wght@900&family=Montserrat:wght@900&family=Licorice&display=swap">
...
<div class="loading" id="loadingScreen">
  <div class="loading-text">
    ...
    <div class="loading-dodch-wrapper">
    ...
    <svg class="loading-stories-svg" viewBox="0 0 400 100">
      <text x="50%" y="60%" dy=".1em" text-anchor="middle">
        Stories
      </text>
    </svg>
  </div>
...
<div class="modal-panel" id="logoutConfirmModal">
    <div class="contact-panel-content" style="text-align: center;">
      <h2 id="logoutModalTitle" style="color: var(--glass-text); font-size: 1.5rem; margin-bottom: 1rem;">Confirm Logout</h2>
      <p id="logoutModalText" style="color: var(--glass-text-p); margin-bottom: 2rem;">Are you sure you want to log out?</p>
      <div style="display: flex; justify-content: center; gap: 1rem;">
        <button id="logoutConfirmBtn" class="panel-button" style="background-color: var(--red-tint);">Logout</button>
        <button id="logoutCancelBtn" class="panel-button">Cancel</button>
      </div>
    </div>
</div>
<div class="close-button" id="closeLogoutModalButton">
